...
static void test_multiple_scores_with_differing_numbers_of_letters(void) {
    legacy_map input[] = {{10, "QZ"}, {1, "AEIOULNRST"}, {3, "BCMP"}, {2, "DG"}, {5, "K"}, {4, "FHVWY"}, {8, "JX"}};
    int input_len = 7;

    new_map expected_map[] = {{'a', 1}, {'b', 3}, {'c', 3}, {'d', 2}, {'e', 1}, {'f', 4}, {'g', 2}, {'h', 4}, {'i', 1}, {'j', 8}, {'k', 5}, {'l', 1}, {'m', 3}, {'n', 1}, {'o', 1}, {'p', 3}, {'q', 10}, {'r', 1}, {'s', 1}, {'t', 1}, {'u', 1}, {'v', 4}, {'w', 4}, {'x', 8}, {'y', 4}, {'z', 10}};
